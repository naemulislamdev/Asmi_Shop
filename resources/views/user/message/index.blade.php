                    ...
                    <div class="user-table table-responsive position-relative">
                        ...
                        <table class="gs-data-table w-100">
                            ...
                            <tbody>
                                @forelse ($convs as $conv)
                                    ...
                                    <tr>
                                        ...
                                        @if ($user->id == $conv->sent->id)
                                            <td><span class="content">{{ $conv->recieved->name }}</span></td>
                                        @else
                                            <td><span class="content">{{ $conv->sent->name }}</span></td>
                                        @endif
                                        <td><span class="content">{{ $conv->subject }}</span>
                                        </td>
                                        <td class="text-center">
                                            <span class="content ">{{ $conv->created_at->diffForHumans() }}
                                            </span>
                                        </td>


                                        <td class="view-btn-wrapper">
                                            <a href="{{ route('user-message', $conv->id) }}" class="view-btn mx-2">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="4">{{ __('No Message Found') }}</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
