                    ...
                    <div class="product-description py-5">
                      <div class="body-area">
                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="col-lg-6">
                              <input type="number" step="0.01" min="0" max="100" class="input-field" placeholder="0" name="first_order_discount_percent" value="{{ $gs->first_order_discount_percent ?? 0 }}">
                            ...
                            <div class="row justify-content-center">
                                    <div class="col-lg-3">
                                        <div class="left-area">
                                            ...
                                            <p class="sub-heading">
                                                {{ __('(Enter the number of points customers will earn for each purchase.)') }}
                                            </p>
                                        </div>
                                    </div>
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            <label>{{ __('Point of Amount') }}</label>
                                            <input class="input-field" name="point_of_amount"
                                                value="{{ $gs->point_of_amount }}" type="number">
                                        </div>
                                    </div>
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            <label>{{ __('Amount of Points') }}</label>
                                            <input class="input-field" name="amount_of_point"
                                                value="{{ $gs->amount_of_point }}" type="number">
                                        </div>
                                    </div>
                                </div>
