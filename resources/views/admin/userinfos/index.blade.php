...
@section('content')
    <input type="hidden" id="headerdata" value="{{ __('USERINFO') }}">

    <div class="content-area">
        <div class="mr-breadcrumb">
            <div class="row">
                <div class="col-lg-6">
                    <h4 class="heading">{{ __('All User Infos') }}</h4>
                    <ul class="links">
                        <li>
                            <a href="{{ route('admin.dashboard') }}">{{ __('Dashboard') }} </a>
                        </li>
                        <li>
                            <a href="javascript:;">{{ __('User Infos') }}</a>
                        </li>
                    </ul>
                </div>
                <div class="col-lg-6">
    ...
    <script type="text/javascript">
        (function($) {
            ...
            var table = $('#geniustable').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: '{{ route('admin-user-info-datatables', 'none') }}',
                columns: [{
                        data: 'date',
                        name: 'date'
                    },
