...
@section('content')
    <div class="content-area">
        <div class="mr-breadcrumb">
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="heading">{{ __('Add Coupon Offer Slider') }} <a class="add-btn" href="{{ route('admin-sl-index') }}"><i
                    ...
                    <ul class="links">
                        ...
                        <li>
                            <a href="{{ route('admin-coupon-slider-create') }}">{{ __('Add Slider') }}</a>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="product-description">
                        <div class="body-area">
                            ...
                            <form id="geniusform" action="{{ route('admin-coupon-slider-store') }}" method="POST"
