...
@section('content')
    ...
    <div class="content-area">
        <div class="mr-breadcrumb">
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="heading">{{ __('Expired Products') }} ({{ $totalExpiredProduct }})</h4>
                    <ul class="links">
                        <li>
                        ...
                        <li>
                            <a href="{{ route('admin-product-expired') }}">{{ __('All Expired Products') }}
                            </a>
                        </li>
                    </ul>
                </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-7">
                    <div class="d-flex flex-column flex-md-row justify-content-between align-items-center p-3">
                        <div>
                            <label>From:</label>
                            <input type="date" id="from_date_export" name="from_ex_date" class="form-control">
                        </div>
                        <div>
                        ...
                        <div>
                            <label>To:</label>
                            <input type="date" name="to_ex_date" id="to_date_export" class="form-control">
                        </div>
                        <div class="d-flex justify-content-between align-items-center">
                            <button id="filterBtn" class="btn btn-primary mt-2 ">{{ __('Filter') }}</button>
                            <button id="clearBtn" class="btn btn-secondary mt-2 ml-3">{{ __('Reset') }}</button>
                        </div>
                    </div>
                </div>
                <div class="col-lg-5">
                    <div class="text-center text-lg-right pr-3">
    ...
    <div class="modal fade" id="exportModal" tabindex="-1" role="dialog" aria-labelledby="exportModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form method="GET" action="{{ route('admin-expired-product-export') }}">
    ...
    <script type="text/javascript">
        (function($) {
            ...
            var table = $('#geniustable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '{{ route('admin-prod-expired-datatables') }}',
                    data: function(d) {
                        d.from = $('#from_date_export').val();
                        d.to = $('#to_date_export').val();
                    }

                },
                // ajax: '{{ route('admin-prod-expired-datatables') }}?type=all',
                columns: [{
                        data: 'photo',
                        name: 'photo'
                    },
