...
Route::as('admin-')->group(function () {
    ...
    Route::group(['middleware' => ['permissions:products', 'not.hr']], function () {
        ...
        Route::get('/products/expired/datatables', 'Admin\ProductController@expiredDatatables')->name('admin-prod-expired-datatables');
    });
    ...
    Route::group(['middleware' => ['permissions:riders', 'not.hr']], function () {
        ...
        Route::get('/rider/default/image', 'Admin\GeneralSettingController@rider_image')->name('admin-rider-image');
    ...
    Route::group(['middleware' => ['permissions:vendors', 'not.hr']], function () {
        ...
        Route::get('/vendor/commission/collect/{id}', 'Admin\VendorController@commissionCollect')->name('admin-vendor-commission-collect');
    ...
    Route::post('/general-settings/update/te=heme', 'Admin\GeneralSettingController@updateTheme')->name('admin-gs-update-theme');
	...
	Route::controller(CustomeOrderController::class)->group(function () {
        ...
        Route::post('/create/customer', 'createCustomer')->name('admin-create-customer');
