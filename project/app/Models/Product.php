...
class Product extends Model
{
    ...
    public static function whereTrending($value)
    {
        return static::where('trending', $value);
    }
    public static function whereStatus($value)
    {
        return static::where('status', $value);
    }
