...
<head>
    ...
    <meta name="author" content="Asmi Shop">
                        ...
                        <div class="right-eliment">
                            <ul class="list">
                                ...
                                <li class="bell-area">
                                    ...
                                    <div class="dropdown-menu">
                                        <div class="ml-3 mt-3">
                                            <a title="Export to Excel" class="btn btn-success btn-sm text-white p-2"
                                                href="{{ route('admin-user-export') }}">Export
                                                Excel</a>
                                        </div>
                                ...
                                <li class="bell-area">
                                    ...
                                    <div class="dropdown-menu">
                                        <div class="pl-3 pt-3 py-0 my-0">
                                            <a class="p-1 rounded border"
                                                href="{{ route('allNotificationView') }}"><i class="fa fa-eye"
                                                    aria-hidden="true"></i> View All Notification</a>
                                        </div>
