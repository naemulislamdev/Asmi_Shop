...
@section('content')
    <div class="content-area">
        <div class="mr-breadcrumb">
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="heading">{{ __('Order Bulk Upload') }}</h4>
                    <ul class="links">
                        <li>
        ...
        <div class="add-product-content">
            <div class="row">
                <div class="col-lg-12 p-5">
                    ...
                    <form id="geniusform" action="{{ route('admin-bulk-upload-custome-order-submit') }}" method="POST"
                        ...
                        <div class="row">
                            <div class="col-lg-12 text-right">
                                <span style="margin-top:10px;"><a class="btn btn-primary"
                                        href="{{ asset('assets/order-csv-format.csv') }}">{{ __('Download Sample CSV') }}</a></span>
                            </div>
