                        ...
                        <div class="body-area">
                            ...
                            <form id="geniusformdata" action="{{ route('admin-subcat-update', $data->id) }}" method="POST"
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="left-area">
                                            <h4 class="heading">{{ __('Main Category') }}*</h4>
                                        </div>
                                    </div>
                                    <div class="col-lg-7">
                                    ...
                                    <div class="col-lg-7">
                                        <div class="img-upload">
                                            <div id="image-preview" class="img-preview"
                                                style="background: url( {{ $data->banner ? asset('assets/images/subcategories/' . $data->banner) : asset('assets/admin/images/upload.png') }});">
                                                <label for="image-upload" class="img-label"><i
                                                        class="icofont-upload-alt"></i>{{ __('Upload Image') }}</label>
                                                <input type="file" name="banner" class="img-upload">
                                            </div>
                                            <p class="text">{{ __('Prefered Size: (1900x267) or Square Sized Image') }}
                                            </p>
                                        </div>
                                    </div>
                                </div>
