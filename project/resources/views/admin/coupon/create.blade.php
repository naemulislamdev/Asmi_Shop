                        ...
                        <div class="body-area">
                            ...
                            <form id="geniusform" action="{{ route('admin-coupon-create') }}" method="POST"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <input type="text" class="input-field" name="start_date" autocomplete="off"
                                            id="from" placeholder="{{ __('Select a date') }}" required=""
                                            value="">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <input type="text" class="input-field" name="end_date" autocomplete="off"
                                            id="to" placeholder="{{ __('Select a date') }}" required=""
                                            value="">
                                    </div>
                                </div>
