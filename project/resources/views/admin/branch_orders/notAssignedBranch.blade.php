...
@section('content')
    <div class="container">
        ...
        <div class="content-area">
            <div class="mr-breadcrumb">
                <div class="row">
                    <div class="col-lg-6">
                        <h4 class="heading"> Not Assigned Branch Orders</h4>
                        <ul class="links">
                            <li>
                            ...
                            <li>
                                <a href="{{ route('admin-orders-all') }}">Not Assigned Branch Orders</a>
                            </li>
                        </ul>
                    </div>
                    <div class="col-lg-4">
            ...
            <div class="card filter-card rounded-bottom-0" style="  box-shadow: 3px 0 6px rgba(0, 0, 0, 0.08) !important;">
                        ...
                        <div class="row mb-4" id="summaryCards">
                            <div class="col-md-3">
                                <div class="summary-card"
                                    style="background: linear-gradient(135deg, #1e3a5f, #2d6a9f); border-radius:14px; padding:20px; color:#fff;">
                                    <div style="font-weight:700; font-size:15px;">All Order</div>
                                    <div style="margin-top:8px; font-size:13px;">
                                        Quantity: <span id="s_total_orders">0</span><br>
                                        Amount: <span id="s_total_amount">0</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="summary-card"
                                    style="background: linear-gradient(135deg, #f4a200, #f7c948); border-radius:14px; padding:20px; color:#fff;">
                                    <div style="font-weight:700; font-size:15px;">Pending</div>
                                    <div style="margin-top:8px; font-size:13px;">
                                        Quantity: <span id="s_pending_qty">0</span><br>
                                        Amount: <span id="s_pending_amount">0</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="summary-card"
                                    style="background: linear-gradient(135deg, #1a5c45, #2d8c6a); border-radius:14px; padding:20px; color:#fff;">
                                    <div style="font-weight:700; font-size:15px;">Complete</div>
                                    <div style="margin-top:8px; font-size:13px;">
                                        Quantity: <span id="s_confirmed_qty">0</span><br>
                                        Amount: <span id="s_confirmed_amount">0</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="summary-card"
                                    style="background: linear-gradient(135deg, #7b1a2a, #c0392b); border-radius:14px; padding:20px; color:#fff;">
                                    <div style="font-weight:700; font-size:15px;">Canceled</div>
                                    <div style="margin-top:8px; font-size:13px;">
                                        Quantity: <span id="s_canceled_qty">0</span><br>
                                        Amount: <span id="s_canceled_amount">0</span>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    @section('scripts')
        ...
        <script type="text/javascript">
            (function($) {
                ...
                var table = $('#geniustable').DataTable({
                    ...
                    ajax: {
                        url: '{{ route('branch-orders.datatables') }}',
                        data: function(d) {
                            d.unassigned = 1; // not assigned page এ এটা যোগ করো
        ...
        <script>
            ...
            var summaryUrl = '{{ route('branch-orders.summary', null) }}';;
            // single branch হলে:
