        ...
        <div class="content-area">
            ...
            @if ($activation_notify != '')
                <div class="alert alert-danger validation">
                    ...
                    <h3 class="text-center">{!! clean($activation_notify, ['Attr.EnableID' => true]) !!}</h3>
                ...
                <div class="col-md-12 col-lg-6 col-xl-4">
                    <div class="mycard bg2">
                        <div class="left">
                            ...
                            <a href="{{ route('admin-orders-all') }}?status=processing"
                                class="link">{{ __('View All') }}</a>
                        </div>
                        <div class="right d-flex align-self-center">
                            <div class="icon">
                ...
                <div class="col-md-12 col-lg-6 col-xl-4">
                    <div class="mycard bg3">
                        <div class="left">
                            ...
                            <a href="{{ route('admin-orders-all') }}?status=completed"
                                class="link">{{ __('View All') }}</a>
                        </div>
                        <div class="right d-flex align-self-center">
                            <div class="icon">
