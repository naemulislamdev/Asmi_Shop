                ...
                <div class="col-lg-12">
                    <div class="product-description">
                        <div class="body-area">
                            ...
                            <form id="geniusformdata" action="{{ route('schedule.store') }}" method="POST"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="time" class="input-field" name="time_form" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label class="heading">To Time *</label>
                                            <input type="time" class="input-field" name="time_to" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <button class="addProductSubmit-btn"
                                            type="submit">{{ __('Create Schedule') }}</button>
                                    </div>
                                </div>
                            </form>
                        </div>
