...
@section('content')
    <div class="content-area">
        ...
        <div class="mr-breadcrumb">
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="heading">{{ __('Add New Branch') }} <a class="add-btn"
                    ...
                    <ul class="links">
                        ...
                        <li>
                            <a href="{{ route('admin-branch-create') }}">{{ __('Add New Branch') }}</a>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="product-description">
                        <div class="body-area">
                            ...
                            <form id="geniusform" action="{{ route('admin-branch-create') }}" method="POST"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <button class="addProductSubmit-btn"
                                            type="submit">{{ __('Create Branch') }}</button>
                                    </div>
                                </div>
                            </form>
                        </div>
