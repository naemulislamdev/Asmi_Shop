...
@section('content')
    ...
    <div class="content-area">
        <div class="mr-breadcrumb">
            <div class="row">
                <div class="col-lg-6">
                    <h4 class="heading">{{ __('Confirmed Pre Order List') }}</h4>
                    <ul class="links">
                        <li>
                        ...
                        <li>
                            <a href="{{ route('admin.pre_order.index') }}">{{ __('Confirmed pre order') }}</a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <script type="text/javascript">
        ...
        (function($) {
            ...
            var table = $('#geniustable').DataTable({
                ...
                ajax: {
                    url: '{{ route('admin.pre_order.datatables', 'confirmed') }}',
                    data: function(d) {
