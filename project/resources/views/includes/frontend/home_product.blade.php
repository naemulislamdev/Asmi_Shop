                        ...
                        @if ($product->type != 'Listing')
                            @if (false)
                                ...
                                <a {{ $product->cross_products ? 'data-bs-target=#exampleModal' : '' }}
                                    href="javascript:;" data-href="{{ route('product.add.to.cart', $product->id) }}"
                                    data-product-id="{{ $product->id }}"
                                    data-cross-href="{{ route('front.show.cross.product', $product->id) }}"
                                    class="outofstock-box-2 add_cart_click {{ $product->cross_products ? 'view_cross_product' : '' }}">
                            ...
                            @else
                                <div class="outofstock-box-2" style="flex-direction: row; gap: 20px;">
                                    ...
                                    <span class="h3 text-white" style="font-weight: 400">2</span>
                                    <button class="btn btn-outline-light rounded-circle border-2 btn-sm"> <i
                                            class="fas fa-plus    "></i></button>
                                </div>
                            @endif
            ...
            @if ($product->stock !== 0)
                @if (false)
                    ...
                    <div class="qty-box mt-auto">
                        ...
                        <span class="qty-text">2 in Bag</span>
                        <button class="qty-btn plus"><i class="fas fa-plus "></i></button>
                    </div>
                @else
                    <div class="w-100 d-block mt-auto">
                        <button
                            class="btn btn-sm add-cart-btn btn-info d-flex d-block w-100 justify-content-center align-items-center"><img
                                style="height: 20px; width: auto;"
                                src="{{ asset('assets/assets/images/icons/flash.png') }}" alt=""> Add To
                            Cart</button>
                    </div>
                @endif
            @endif
