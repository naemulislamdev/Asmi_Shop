@if (Auth::guard('admin')->user()->role_id != 0)
    ...
    @if ($admin && $admin->email == 'hr.asmishop@gmail.com')
        ...
        <li>
            ...
            <ul class="collapse list-unstyled" id="menuCareer">
                <li>
                    <a href="{{ route('career.jobs') }}">
                ...
                <li>
                    <a href="{{ route('career.departments') }}">
    ...
    @else
        ...
        @if (Auth::guard('admin')->user()->sectionCheck('manage-country'))
            ...
            @if (Auth::guard('admin')->user()->sectionCheck('earning'))
                <li>
                    <a href="#income" class="accordion-toggle wave-effect" data-toggle="collapse"
                        aria-expanded="false"><i class="fas fa-hand-holding-usd"></i>{{ __('Total Earning') }}</a>
        ...
        @if (Auth::guard('admin')->user()->sectionCheck('products'))
            <li>
                ...
                <ul class="collapse list-unstyled" id="menu2" data-parent="#accordion">
                    ...
                    <li>
                        <a
                            href="{{ route('admin-prod-catalog-index') }}"><span>{{ __('Product Catalogs') }}</span></a>
                    </li>
                    <li>
        ...
        @if (Auth::guard('admin')->user()->sectionCheck('customer_deposits'))
            <li>
                <a href="#customerDeposit" class="accordion-toggle wave-effect" data-toggle="collapse"
                    aria-expanded="false">
                ...
                <ul class="collapse list-unstyled" id="customerDeposit" data-parent="#accordion">
                    <li>
                        <a
                            href="{{ route('admin-user-deposits', 'all') }}"><span>{{ __('Completed Deposits') }}</span></a>
                    </li>
                    <li>
                        <a
                            href="{{ route('admin-user-deposits', 'pending') }}"><span>{{ __('Pending Deposits') }}</span></a>
                    </li>
                    <li>
        ...
        @if (Auth::guard('admin')->user()->sectionCheck('vendor_subscriptions'))
            <li>
                <a href="#vendorSubs" class="accordion-toggle wave-effect" data-toggle="collapse"
                    aria-expanded="false">
        ...
        @if (Auth::guard('admin')->user()->sectionCheck('vendor_verifications'))
            <li>
                <a href="#vendor1" class="accordion-toggle wave-effect" data-toggle="collapse"
                    aria-expanded="false">
                ...
                <ul class="collapse list-unstyled" id="vendor1" data-parent="#accordion">
                    ...
                    <li>
                        <a
                            href="{{ route('admin-vr-index', 'pending') }}"><span>{{ __('Pending Verifications') }}</span></a>
                    </li>
                </ul>
            </li>
        @endif
        ...
        @if (Auth::guard('admin')->user()->sectionCheck('general_settings'))
            <li>
                ...
                <ul class="collapse list-unstyled" id="general" data-parent="#accordion">
                    ...
                    <li>
                        <a
                            href="{{ route('admin-gs-maintenance') }}"><span>{{ __('Website Maintenance') }}</span></a>
                    </li>
        ...
        @if (Auth::guard('admin')->user()->sectionCheck('home_page_settings'))
            <li>
                ...
                <ul class="collapse list-unstyled" id="homepage" data-parent="#accordion">
                    ...
                    <li>
                        <a
                            href="{{ route('admin-arrival-index') }}"><span>{{ __('Best Month Offer Section') }}</span></a>
                    </li>
                    <li>
        ...
        @if (Auth::guard('admin')->user()->sectionCheck('menu_page_settings'))
            <li>
                ...
                <ul class="collapse list-unstyled" id="menu" data-parent="#accordion">
                    ...
                    <li>
                        <a
                            href="{{ route('admin-ps-menu-links') }}"><span>{{ __('Customize Menu Links') }}</span></a>
                    </li>
                </ul>
            </li>
        @endif
        ...
        @if (Auth::guard('admin')->user()->sectionCheck('payment_settings'))
            <li>
                ...
                <ul class="collapse list-unstyled" id="payments" data-parent="#accordion">
                    <li><a href="{{ route('admin-gs-payments') }}"><span>{{ __('Payment Information') }}</span></a>
                    </li>
                    <li><a href="{{ route('admin-payment-index') }}"><span>{{ __('Payment Gateways') }}</span></a>
                    </li>
                    <li><a href="{{ route('admin-currency-index') }}"><span>{{ __('Currencies') }}</span></a></li>
                    <li><a href="{{ route('admin-reward-index') }}"><span>{{ __('Reward Information') }}</span></a>
                    </li>
                </ul>
            </li>
        @endif
        ...
        @if (Auth::guard('admin')->user()->sectionCheck('social_settings'))
            <li>
                ...
                <ul class="collapse list-unstyled" id="socials" data-parent="#accordion">
                    <li><a href="{{ route('admin-sociallink-index') }}"><span>{{ __('Social Links') }}</span></a>
                    </li>
                    <li><a href="{{ route('admin-social-facebook') }}"><span>{{ __('Facebook Login') }}</span></a>
                    </li>
        ...
        @if (Auth::guard('admin')->user()->sectionCheck('language_settings'))
            <li>
                ...
                <ul class="collapse list-unstyled" id="langs" data-parent="#accordion">
                    <li><a href="{{ route('admin-lang-index') }}"><span>{{ __('Website Language') }}</span></a>
                    </li>
                    <li><a
